                ...
                <form action="mt-4" >
                    {isSignUpForm &&
                        ...
                        <div className="mb-6">
                            ...
                            <input type="text" ref={name} id="name" className="w-full mt-2  bg-gray-700 p-2 rounded text-white hover:bg-gray-800 focus:bg-gray-800 transition-all " />
                    ...
                    <div className="mb-6">
                        ...
                        <input ref={email} type="email" id="email" className="w-full mt-2    bg-gray-700 p-2 rounded text-white hover:bg-gray-800 focus:bg-gray-800 transition-all" />
                    ...
                    <div>
                        ...
                        <input type="password" ref={password} id="password" className="w-full bg-gray-700 mt-2 p-2 rounded text-white hover:bg-gray-800 focus:bg-gray-800 transition-all" />
                        {isSignUpForm &&
                    ...
                    <div className="text-center mt-6">
                        ...
                        <button type="submit" className="bg-red-600 text-white block w-full p-3 font-bold rounded hover:bg-red-700" onClick={validateForm}>Sign {isSignUpForm ? "Up" : "In"}</button>
                        {/* </a> */}
                    </div>
